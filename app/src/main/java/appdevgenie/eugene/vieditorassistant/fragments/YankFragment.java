...
public class YankFragment extends Fragment {
    ...
    private void initialize() {
        ...
        tvListLabel.setText(getString(R.string.yank));

        ListView lvMain = (ListView) view.findViewById(R.id.lvListView);

        String[] title = context.getResources().getStringArray(R.array.copy_title);
        String[] description = context.getResources().getStringArray(R.array.copy_disc);
